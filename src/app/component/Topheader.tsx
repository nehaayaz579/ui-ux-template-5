...
const Topheader = () => {
  return (
    <div className="hidden sm:block">
      <div className=" w-full  h-[46px] bg-[#252B42] flex justify-between items-center px-4 sm:px-8">
        {/* Left side: Phone and Email */}
        <div className="flex text-[#FFFFFF] items-center space-x-3 sm:space-x-5">
          <div className="flex items-center">
            <LuPhone className="text-white" />
            <h6 className="font-[700] text-[14px] leading-[24px] ml-2">
              (225) 555-0118
            </h6>
          </div>
        ...
        <div className="hidden sm:flex items-center text-[#FFFFFF]">
          <h6 className="font-[700] text-[14px] leading-[24px]">
        ...
        <div className="flex items-center space-x-3 sm:space-x-5">
          <h6 className="text-[#FFFFFF] font-[700] text-[14px] leading-[24px]">
            Follow Us:{" "}
          </h6>
